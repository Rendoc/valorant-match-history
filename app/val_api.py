...
class ValorantAPI(object):
    ...
    def get_match_comp_history(self):
        json_match = self.get_match_history()
        comp_json = [match for match in json_match['Matches'] if match['CompetitiveMovement'] != 'MOVEMENT_UNKNOWN']
        return comp_json